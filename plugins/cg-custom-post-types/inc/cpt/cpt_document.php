...
function register_cpt_document() {
	...
	$labels = array(
		'name'               => _x( "Documents", 'post type general name', 'cgranby-cc' ),
		'singular_name'      => _x( "Document", 'post type singular name', 'cgranby-cc' ),
		'menu_name'          => _x( "Documents", 'admin menu', 'cgranby-cc' ),
		'name_admin_bar'     => _x( "Document", 'add new on admin bar', 'cgranby-cc' ),
		'add_new'            => _x( 'Ajouter', 'Custom Post Type', 'cgranby-cc' ),
		'add_new_item'       => __( 'Ajouter un nouveau document', 'cgranby-cc' ),
		'new_item'           => __( 'Nouveau', 'cgranby-cc' ),
		'edit_item'          => __( 'Éditer', 'cgranby-cc' ),
		'view_item'          => __( "Consulter", 'cgranby-cc' ),
		'all_items'          => __( 'Tous les documents', 'cgranby-cc' ),
		'search_items'       => __( 'Rechercher', 'cgranby-cc' ),
		'not_found'          => __( "Aucun document.", 'cgranby-cc' ),
		'not_found_in_trash' => __( "Aucun document dans la corbeille.", 'cgranby-cc' )
	);

	$args = array(
		'labels'               => $labels, // An array of labels for this post type. 
		'description'          => __( "Gestion des documents - utilisés par le module de contenu flexible : <em>Liste de contenus - documents</em>", 'cgranby-cc' ), // A short descriptive summary of what the post type is.
