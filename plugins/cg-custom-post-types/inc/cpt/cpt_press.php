...
function register_cpt_press() {
	...
	$labels = array(
		'name'               => _x( "Revue de presse", 'post type general name', 'cgranby-cc' ),
		'singular_name'      => _x( "Article", 'post type singular name', 'cgranby-cc' ),
		'menu_name'          => _x( "Revue de presse", 'admin menu', 'cgranby-cc' ),
		'name_admin_bar'     => _x( "Article", 'add new on admin bar', 'cgranby-cc' ),
		'add_new'            => _x( 'Ajouter', 'Custom Post Type', 'cgranby-cc' ),
		'add_new_item'       => __( 'Ajouter un nouvel article', 'cgranby-cc' ),
		'new_item'           => __( 'Nouveau', 'cgranby-cc' ),
		'edit_item'          => __( 'Éditer', 'cgranby-cc' ),
		'view_item'          => __( "Consulter", 'cgranby-cc' ),
		'all_items'          => __( 'Tous les articles', 'cgranby-cc' ),
		'search_items'       => __( 'Rechercher', 'cgranby-cc' ),
		'not_found'          => __( "Aucun article.", 'cgranby-cc' ),
		'not_found_in_trash' => __( "Aucun article dans la corbeille.", 'cgranby-cc' )
	);

	$args = array(
		'labels'               => $labels, // An array of labels for this post type. 
		'description'          => __( "Gestion des articles - utilisés par le module de contenu flexible : <em>Liste de contenus - revue de presse</em>", 'cgranby-cc' ), // A short descriptive summary of what the post type is.
	...
	register_post_type( 'press', $args ); // Registers the post type.
}
