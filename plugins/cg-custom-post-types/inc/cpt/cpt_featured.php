...
add_action( 'init' ,'register_cpt_collaboration');
...
function register_cpt_collaboration() {

	$labels = array(
		'name'               => _x( "Collaborations", 'post type general name', 'cgranby-cc' ),
		'singular_name'      => _x( "Collaboration", 'post type singular name', 'cgranby-cc' ),
		'menu_name'          => _x( "Collaborations", 'admin menu', 'cgranby-cc' ),
		'name_admin_bar'     => _x( "Collaboration", 'add new on admin bar', 'cgranby-cc' ),
		'add_new'            => _x( 'Ajouter', 'Custom Post Type', 'cgranby-cc' ),
		'add_new_item'       => __( 'Ajouter une nouvelle collaboration', 'cgranby-cc' ),
		'new_item'           => __( 'Nouvelle', 'cgranby-cc' ),
		'edit_item'          => __( 'Éditer', 'cgranby-cc' ),
		'view_item'          => __( "Consulter", 'cgranby-cc' ),
		'all_items'          => __( 'Toutes les collaborations', 'cgranby-cc' ),
		'search_items'       => __( 'Rechercher', 'cgranby-cc' ),
		'not_found'          => __( "Aucune collaboration.", 'cgranby-cc' ),
		'not_found_in_trash' => __( "Aucune collaboration dans la corbeille.", 'cgranby-cc' )
	);

	$args = array(
		'labels'               => $labels, // An array of labels for this post type. 
		'description'          => __( "Gestion des collaborations - utilisées par le module de contenu flexible : <em>Liste de contenus - collaborations</em>", 'cgranby-cc' ), // A short descriptive summary of what the post type is.
	...
	register_post_type( 'collaboration', $args ); // Registers the post type.
}
