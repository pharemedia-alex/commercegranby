...
@section('content')
  ...
  @php
    ...
    $page_header->content->title = __('Page unavailable', 'commercegranby-theme');
    $page_header->content->subtitle = __('We are sorry, the page you were trying to view does not exist.', 'commercegranby-theme');
  @endphp
