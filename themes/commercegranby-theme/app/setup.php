...
add_action('wp_enqueue_scripts', function () {
    ...
    wp_enqueue_style( 'google_fonts', 'https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,400;0,600;0,700;0,800;1,400;1,600&display=swap', false, null );
...
add_action('widgets_init', function () {
    ...
    register_sidebar([
        'name'          => __('Primary', 'commercegranby-theme'),
        'id'            => 'sidebar-primary'
    ] + $config);
    register_sidebar([
        'name'          => __('Footer', 'commercegranby-theme'),
        'id'            => 'sidebar-footer'
    ] + $config);
});
